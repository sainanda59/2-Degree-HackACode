    ...
    return (
        ...
        <div className="moto-main">
            <div className="moto-left">
                <h1 data-aos="fade-right" data-aos-delay="300">Our Motive</h1>
                <p data-aos="fade-right" data-aos-delay="400">Global warming is the increase of average world temperature as a result of what is known as the greenhouse effect. Certain gases in the atmosphere act like glass in a greenhouse, allowing sunlight through to heat the earth's surface but trapping the heat as it radiates back into space.
            ...
            <div className="moto-right">
                ...
                src="https://www.youtube.com/embed/JfA45BKa0NQ" data-aos="fade-up" data-aos-delay="500" title={"video"}/>
